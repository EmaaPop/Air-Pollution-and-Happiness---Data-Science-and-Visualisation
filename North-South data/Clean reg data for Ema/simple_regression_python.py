...
plt.title('The rate of change of Northeast Pacific White shark population over 9 consecutive years')
plt.xlabel('t + 1, where t represents a year of measurement')
plt.ylabel('r value')
